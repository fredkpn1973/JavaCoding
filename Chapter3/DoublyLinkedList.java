...
public class DoublyLinkedList<E> {
  ...
  public E findMiddel() {
    if (isEmpty())
      return null;
    Node<E> walkForward = header.getNext();
    Node<E> walkBackward = trailer.getPrev();
    while (!(walkForward.getElement() == walkBackward.getElement())) {
      walkForward = walkForward.getNext();
      walkBackward = walkBackward.getPrev();
      if (walkForward == walkBackward.getNext() && walkBackward == walkForward.getPrev()) {
        walkForward = walkBackward;
      }
    }
    return walkForward.getElement();
  }
